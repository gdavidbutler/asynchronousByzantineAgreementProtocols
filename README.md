...
| `test_bkr94acs_blackbox` | Protocol black-box (bkr94acs) | Sections A-Q: Lemma 2 Parts A-D, Input dedup, Retry and quiescence under drop, EXHAUSTED, the equivocating A-Caster, step-2 and round-turn pacing, the *Abandonment* scenarios (Sections I-N), a BA's decision versus this process's input, annotation forgery, and the paired payload's retire and hold -- no `.c` reads |
