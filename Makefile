...
bracha87Fig1Rules.c: bracha87Fig1.psu psu.awk
...
bracha87Fig3Rules.c: bracha87Fig3.psu psu.awk
...
bracha87Fig4Rules.c: bracha87Fig4.psu psu.awk
...
clean:
	rm -f bracha87Fig1Rules.c bracha87Fig3Rules.c bracha87Fig4Rules.c bkr94acsRules.c
